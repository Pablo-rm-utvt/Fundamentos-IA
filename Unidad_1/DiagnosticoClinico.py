...
estilo = ttk.Style()
estilo.configure("Titulo.TLabel", font=("Helvetica", 18, "bold"))
estilo.configure("Seccion.TLabel", font=("Helvetica", 11, "bold"))
...
ttk.Checkbutton(sintomas_frame, text="Fiebre", variable=fiebre_var).pack(side="left", padx=8)
ttk.Checkbutton(sintomas_frame, text="Tos", variable=tos_var).pack(side="left", padx=8)
ttk.Checkbutton(sintomas_frame, text="Dolor de garganta", variable=dolor_var).pack(side="left", padx=8)

ttk.Button(contenedor, text="Evaluar y generar cita", command=evaluar).pack(pady=(0, 12))
