...
lista_oficial = input("Estas en la lista oficial? (si/no)").lower()

##Aqui agregamos si tiene adeudos o no el alumno

Adeudo = input('Tienes algun adeudo? (si/no) : ').lower()
...
print("L - Lista Oficial: ", L)
print("A - Sin Adeudos: ", A)
...
## Se agrega la nueva condicion de los adeudos


expresion = (P and Q and L and A) or (S and A)

print("\nEXPRESIÓN CON PARÉNTESIS")
print("(P ∧ Q ∧ L ∧ A) ∨ (S ∧ A) =", expresion)
